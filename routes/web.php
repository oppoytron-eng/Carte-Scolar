...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:Proviseur,Administrateur')->prefix('proviseur')->name('proviseur.')->group(function () {
        ...
        Route::post('eleves/{eleve}/validate', [EleveController::class, 'validateEleve'])->name('eleves.validate');
    ...
    Route::middleware('role:Surveillant General,Proviseur,Administrateur')->prefix('surveillant')->name('surveillant.')->group(function () {
        Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard');
        ...
        // Impression
        Route::get('/impression', [SurveillantController::class, 'impression'])->name('impression.index');
        Route::get('/impression/batch', [CarteController::class, 'impressionBatch'])->name('impression.batch');
        ...
        Route::get('/rapports/classe/{classe}/export', [ReportController::class, 'exportClassePdf'])->name('rapports.classe.export');
    });
    ...
    // Validation photos (accessible aussi en dehors du prefix surveillant)
    Route::get('/photos/validation', [PhotoController::class, 'validationIndex'])->name('photos.validation');

    // Cartes (accessible en dehors du prefix aussi)
    Route::get('/cartes', [CarteController::class, 'index'])->name('cartes.index');
    Route::get('/cartes/{carte}', [CarteController::class, 'show'])->name('cartes.show');
});
